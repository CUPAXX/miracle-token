...
const MatrixRain = () => {
  ...
  useEffect(() => {
    ...
    const frameRate = 80; // Adjust the frame rate (lower value = slower speed)
    ...
    const draw = () => {
      ...
      ctx.fillStyle = "#fcdb03"; // color for characters
  ...
  return (
    <canvas
      className="matrix-canvas fixed top-0 left-0 -z-50"
      ref={canvasRef}
    />
  );
};
